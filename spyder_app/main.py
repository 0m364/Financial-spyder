...
def main():
    parser = argparse.ArgumentParser(
        description="Financial Spyder - Corporate Analysis Tool"
    )
    parser.add_argument(
        "--url",
        type=str,
    ...
    parser.add_argument(
        "--ticker", type=str, default=config.DEFAULT_TICKER, help="Ticker symbol"
    )
    parser.add_argument(
        "--tier",
        type=str,
    ...
    parser.add_argument(
        "--hook", action="store_true", help="Run the AI Bot Hook after analysis"
    )
